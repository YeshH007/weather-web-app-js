let apikey = "e174e1c22a6530182c2fd557758f090d"
...
async function getweather(searchval) {
    let getdata = fetch(`https://api.weatherapi.com/v1/current.json?key="e174e1c22a6530182c2fd557758f090d"&q=${searchval}&aqi=no`);
